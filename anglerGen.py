...
class AnglerGen:
    ...
    def generateCode(self):
        ...
        # removes this delete body that should not have been generated by the openapi gen CLI
        # TODO: remove this once gen is fixed
        removeDeleteBody(f"{self.createPath}/api", self.isVerbose)
